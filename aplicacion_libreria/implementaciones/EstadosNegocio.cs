...
namespace aplicacion_libreria.implementaciones
{
    public class EstadosNegocio : IEstadosNegocio
    {
        ...
        public List<Estados> Consultar()
        {
            ...
            auditorias.Descripcion = "Se consultó la lista de Estados";
        ...
        public Estados Guardar(Estados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se Guardó un nuevo Estado";
            this.iConexion.Auditorias!.Add(auditorias);
        ...
        public Estados Modificar(Estados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se modificó un  Estado";
            this.iConexion.Auditorias!.Add(auditorias);
        ...
        public void Borrar(Estados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se borró un Estado";
            this.iConexion.Auditorias!.Add(auditorias);
