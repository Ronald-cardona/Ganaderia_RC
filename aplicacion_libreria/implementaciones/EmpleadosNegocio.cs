...
namespace aplicacion_libreria.implementaciones
{
    public class EmpleadosNegocio : IEmpleadosNegocio
    {
        ...
        public List<Empleados> Consultar()
        {
            ...
            auditorias.Descripcion = "Se consultó la lista de Empleados";
        ...
        public Empleados Guardar(Empleados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se Guardó un nuevo Empleado";
            this.iConexion.Auditorias!.Add(auditorias);
        ...
        public Empleados Modificar(Empleados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se modificó un Empleado";
            this.iConexion.Auditorias!.Add(auditorias);
        ...
        public void Borrar(Empleados entidad)
        {
            ...
            auditorias.Fecha = DateTime.Now;
            auditorias.Descripcion = "Se borró un Empleado";
            this.iConexion.Auditorias!.Add(auditorias);
