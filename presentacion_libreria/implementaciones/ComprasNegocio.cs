...
namespace presentacion_libreria.implementaciones
{
    public class ComprasNegocio : IComprasNegocio
    {
        ...
        public List<Compras> Consultar(string correo)
        {
            ...
            datos["Url"] = $"http://localhost:5241/Compras/Consultar?correo={correo}";  // lo ponemos asi para que pueda saber cual es el correo
        ...
        public Compras Guardar(Compras entidad, string correo)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = $"http://localhost:5241/Compras/Guardar?correo={correo}";
