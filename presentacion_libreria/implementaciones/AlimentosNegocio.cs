...
namespace presentacion_libreria.implementaciones
{
    public class AlimentosNegocio : IAlimentosNegocio
    {
        ...
        public List<Alimentos> Consultar(string correo)
        {
            ...
            datos["Url"] = $"http://localhost:5241/Alimentos/Consultar?correo={correo}"; // lo ponemos asi para que pueda saber cual es el correo
        ...
        public Alimentos Guardar(Alimentos entidad, string correo)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = $"http://localhost:5241/Alimentos/Guardar?correo={correo}";
