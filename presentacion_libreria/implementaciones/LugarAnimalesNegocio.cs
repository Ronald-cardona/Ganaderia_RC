...
namespace presentacion_libreria.implementaciones
{
    public class LugarAnimalesNegocio : ILugarAnimalesNegocio
    {
        ...
        public List<LugarAnimales> Consultar(string correo)
        {
            ...
            datos["Url"] = $"http://localhost:5241/LugarAnimales/Consultar?correo={correo}";  // lo ponemos asi para que pueda saber cual es el correo
        ...
        public LugarAnimales Guardar(LugarAnimales entidad, string correo)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = $"http://localhost:5241/LugarAnimales/Guardar?correo={correo}";
